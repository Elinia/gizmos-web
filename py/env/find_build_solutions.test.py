...
class TestStringMethods(unittest.TestCase):
    ...
    def test_basic_double_converter(self):
        ...
        solutions = find_build_solutions(
            "blue", 3, init_energy_num({"blue": 2}), [g1], False
        )
        self.assertEqual(len(solutions), 1)
    ...
    def test_basic_double_and_any_converter(self):
        ...
        solutions = find_build_solutions(
            "yellow", 2, init_energy_num({"blue": 1}), [g1, g2], False
        )
        self.assertEqual(len(solutions), 1)
    ...
    def test_double_level3_and_any_converter(self):
        ...
        solutions = find_build_solutions(
            "blue", 6, init_energy_num({"blue": 4, "yellow": 1}), [g1, g2], False
        )
        self.assertEqual(len(solutions), 1)
        energy_num = solutions[0]["energy_num"]
        gizmos = solutions[0]["gizmos"]
    ...
    def test_any_to_any_and_formulae_length_over_than_1(self):
        ...
        energy_num = solutions[0]["energy_num"]
        gizmos = solutions[0]["gizmos"]
        self.assertEqual(energy_num, init_energy_num({"red": 2, "black": 2, "blue": 2}))
    ...
    def test_build_any_with_double(self):
        ...
        self.assertEqual(
            energy_num, init_energy_num({"red": 1, "yellow": 1, "blue": 1})
        )
        self.assertSetEqual(set(gizmos), set([g1, g2]))
    ...
    def test_complex(self):
        ...
        solutions = find_build_solutions(
            "black", 5, init_energy_num({"black": 3}), [g1, g2, g3, g4, g5], False
        )
        self.assertEqual(len(solutions), 1)
    ...
    def test_build_any(self):
        solutions = find_build_solutions(
            "any", 7, init_energy_num({"red": 5, "blue": 1, "black": 1}), [], False
        )
        self.assertEqual(len(solutions), 1)
    ...
    def test_bug_case_1(self):
        ...
        solutions = find_build_solutions(
            "blue", 2, init_energy_num({"red": 2, "black": 1}), [g1], False
        )
        self.assertEqual(len(solutions), 1)
