...
class FeatureGen(object):
    ...
    def gen_context_feature(self, ob: Observation):
        ...
        feature = [
            ...
            gen('my_giz', lget_my_giz(me['gizmos'], 0)),
            gen('my_giz', lget_my_giz(me['gizmos'], 1)),
            gen('my_giz', lget_my_giz(me['gizmos'], 2)),
            gen('my_giz', lget_my_giz(me['gizmos'], 3)),
            gen('my_giz', lget_my_giz(me['gizmos'], 4)),
            gen('my_giz', lget_my_giz(me['gizmos'], 5)),
            gen('my_giz', lget_my_giz(me['gizmos'], 6)),
            gen('my_giz', lget_my_giz(me['gizmos'], 7)),
            gen('my_giz', lget_my_giz(me['gizmos'], 8)),
            gen('my_giz', lget_my_giz(me['gizmos'], 9)),
            gen('my_giz', lget_my_giz(me['gizmos'], 10)),
            gen('my_giz', lget_my_giz(me['gizmos'], 11)),
            gen('my_giz', lget_my_giz(me['gizmos'], 12)),
            gen('my_giz', lget_my_giz(me['gizmos'], 13)),
            gen('my_giz', lget_my_giz(me['gizmos'], 14)),
            gen('my_giz', lget_my_giz(me['gizmos'], 15)),
